  ...
  animations: [
    trigger("inOutAnimation", [
      transition(":enter", [
        ...
        animate(".6s ease-out", style({ 'margin-right': '8px', 'margin-left': '8px', height: 280 }))
      ]),
      // //with opacity
      // transition(":enter", [
      ...
      // ]),
      transition(":leave", [
        style({ 'padding-bottom': 0, 'margin-top': 0, opacity: 1, 'z-index': 100 }),
        group([
          animate(".5s ease-out", style({ 'padding-bottom': 300, 'margin-top': -300,  'margin-right': -100, 'margin-left': -100 })),
          sequence( [
